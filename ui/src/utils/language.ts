...
const ENGLISH_STRINGS: { [key in STRING]: string } = {
  ...
  [STRING.TRACK_EXTEND_ALREADY_ADDED]: 'Already in this track',
  ...
  [STRING.TRACK_NEXT_FRAME]: 'Next frame',
  ...
  [STRING.TRACK_PATH_RANGE]: '{{start}}–{{end}} · {{count}} frames',
  ...
  [STRING.TRACK_PREVIOUS_FRAME]: 'Previous frame',
  ...
  [STRING.TRACK_WHEN_OVERLAPS]: 'Overlaps',
