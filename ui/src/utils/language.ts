...
const ENGLISH_STRINGS: { [key in STRING]: string } = {
  ...
  [STRING.TRACK_EXTEND_HINT]:
    'Click a box to add it, then go to the next capture',
  ...
  [STRING.TRACK_EXTEND_NEXT_CAPTURE]: 'Next capture',
  [STRING.TRACK_EXTEND_STATUS]: 'Extending {{name}}',
