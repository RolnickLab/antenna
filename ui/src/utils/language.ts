export enum STRING {
  ...
  DETAILS_LABEL_EXAMPLE_CAPTURES,
  DETAILS_LABEL_GENERAL,
  DETAILS_LABEL_IMAGES_PROCESSED,
  DETAILS_LABEL_ITEMS_DETECTED,
...
const ENGLISH_STRINGS: { [key in STRING]: string } = {
  ...
  [STRING.DETAILS_LABEL_BATCH_SIZE]: 'Batch size',
  ...
  [STRING.DETAILS_LABEL_DETECTIONS]: 'Detection(s)',
  ...
  [STRING.DETAILS_LABEL_EXAMPLE_CAPTURES]: 'Example captures',
  [STRING.DETAILS_LABEL_GENERAL]: 'General',
  [STRING.DETAILS_LABEL_IMAGES_PROCESSED]: 'Images processed',
  [STRING.DETAILS_LABEL_ITEMS_DETECTED]: 'Items detected',
  ...
  [STRING.TABLE_COLUMN_CAPTURES]: 'Captures',
