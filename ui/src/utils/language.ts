export enum STRING {
  ...
  FIELD_LABEL_OOD_SCORE,
  FIELD_LABEL_OOD_SCORE_THRESHOLD,
  FIELD_LABEL_PARENT,
...
const ENGLISH_STRINGS: { [key in STRING]: string } = {
  ...
  [STRING.FIELD_LABEL_OOD_SCORE]: 'OOD score',
  [STRING.FIELD_LABEL_OOD_SCORE_THRESHOLD]: 'OOD score threshold',
  [STRING.FIELD_LABEL_PARENT]: 'Parent',
  ...
  [STRING.OR]: 'Or',
  [STRING.OUT_OF_DISTRIBUTION_SCORE]: 'Out of distribution score\n{{score}}',
