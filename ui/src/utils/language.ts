export enum STRING {
  ...
  /* FIELD_LABEL */
  FIELD_LABEL_ACCURACY_BY_SPECIES,
  ...
  FIELD_LABEL_OCCURRENCES_SCORED,
  FIELD_LABEL_OCCURRENCES_SKIPPED,
  ...
  FIELD_LABEL_TYPE,
  FIELD_LABEL_SPECIES,
  FIELD_LABEL_TRAINING_DATA,
  FIELD_LABEL_TRAINING_IMAGES_READY,
...
const ENGLISH_STRINGS: { [key in STRING]: string } = {
  ...
  /* FIELD_LABEL */
  [STRING.FIELD_LABEL_ACCURACY_BY_SPECIES]: 'Accuracy by species',
  ...
  [STRING.FIELD_LABEL_CROPS_WITHOUT_EMBEDDING]: 'Crops waiting for embeddings',
  ...
  [STRING.FIELD_LABEL_OCCURRENCES_SCORED]: 'Occurrences scored',
  [STRING.FIELD_LABEL_OCCURRENCES_SKIPPED]:
    '{{count}} skipped: not a species this model can predict',
  ...
  [STRING.FIELD_LABEL_TRAINING_DATA]: 'Training data',
  [STRING.FIELD_LABEL_TRAINING_IMAGES_READY]: 'Training images ready',
