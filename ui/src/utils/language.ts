export enum STRING {
  ...
  FIELD_LABEL_REPORTED_STATUS,
  FIELD_LABEL_STATION_STATUS,
  FIELD_LABEL_STORAGE_FREE,
  FIELD_LABEL_SOFTWARE_VERSION,
...
const ENGLISH_STRINGS: { [key in STRING]: string } = {
  ...
  [STRING.FIELD_LABEL_BATTERY]: 'Battery',
  ...
  [STRING.FIELD_LABEL_REPORTED_STATUS]: 'Reported status',
  [STRING.FIELD_LABEL_STATION_STATUS]: 'Station status',
  [STRING.FIELD_LABEL_STORAGE_FREE]: 'Storage free',
  [STRING.FIELD_LABEL_SOFTWARE_VERSION]: 'Software version',
