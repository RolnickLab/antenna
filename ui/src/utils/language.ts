export enum STRING {
  ...
  FIELD_LABEL_DEVICE_ID,
  FIELD_LABEL_REPORTED_BY_DEVICE,
  STATION_ONLINE,
...
const ENGLISH_STRINGS: { [key in STRING]: string } = {
  ...
  [STRING.FIELD_LABEL_DEVICE_ID]: 'Device ID',
  [STRING.FIELD_LABEL_REPORTED_BY_DEVICE]: 'Reported by the device',
  [STRING.STATION_ONLINE]: 'Reporting now',
  [STRING.STATION_NOT_REPORTING]: 'Not reporting right now',
