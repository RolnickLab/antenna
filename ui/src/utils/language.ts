export enum STRING {
  ...
  SETTINGS,
  SORT_BY,
  SORT_RECENT_IDENTIFICATIONS,
  SORT_RECENT_JOBS,
  SORT_RECENT_OBSERVATIONS,
  STAGES,
  SUMMARY,
  TABLE_COLUMNS,
...
const ENGLISH_STRINGS: { [key in STRING]: string } = {
  ...
  [STRING.SORT_RECENT_IDENTIFICATIONS]: 'Recent identifications',
  [STRING.SORT_RECENT_JOBS]: 'Recent jobs',
  [STRING.SORT_RECENT_OBSERVATIONS]: 'Recent observations',
