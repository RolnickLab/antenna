export enum STRING {
  ...
  NAV_ITEM_PROJECT,
  NAV_ITEM_PROJECT_CONFIGURATION,
  NAV_ITEM_PROJECT_COVER,
  NAV_ITEM_PROJECTS,
  NAV_ITEM_SESSIONS,
  NAV_ITEM_SITES,
  NAV_ITEM_STORAGE,
...
const ENGLISH_STRINGS: { [key in STRING]: string } = {
  ...
  [STRING.NAV_ITEM_PROJECT_CONFIGURATION]: 'Project configuration',
  [STRING.NAV_ITEM_PROJECT_COVER]: 'Project cover',
