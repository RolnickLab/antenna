...
class AlgorithmCategoryMapResponse(pydantic.BaseModel):
    ...
    description: str | None = pydantic.Field(
        ...
        examples=[
            "LepNet2021 with Schmidt 2023 corrections. Limited to species with > 1000 observations."
        ],
    )
...
class AlgorithmConfigResponse(pydantic.BaseModel):
    ...
    key: str = pydantic.Field(
        description=(
            "A unique key for an algorithm to lookup the category map (class list) and other metadata."
        ),
    )
...
PipelineChoice = typing.Literal[
    # @TODO can this be dynamically generated from available pipelines?
