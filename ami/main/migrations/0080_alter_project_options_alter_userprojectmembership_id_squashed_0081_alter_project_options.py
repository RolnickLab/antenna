# Generated by Django 4.2.10 on 2025-12-05 01:35
...
class Migration(migrations.Migration):
    replaces = [
        ("main", "0080_alter_project_options_alter_userprojectmembership_id"),
        ("main", "0081_alter_project_options"),
    ]

    dependencies = [
        ("main", "0079_userprojectmembership_migration"),
    ]

    operations = [
        migrations.AlterField(
            model_name="userprojectmembership",
            name="id",
