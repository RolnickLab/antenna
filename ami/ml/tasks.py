...
def process_and_save_images(self, pipeline_choice: str, endpoint_url: str, image_ids: list[int], job_id: int | None):
    ...
    results = process_images(pipeline_choice=pipeline_choice, endpoint_url=endpoint_url, images=images, job_id=job_id)
