...
class ProjectMixin:
    ...
    require_project = False  # Opt-in: require project_id for all actions
    require_project_for_list = False  # Opt-in: require project_id for the list action only
    request: rest_framework.request.Request
    ...
    def get_active_project(self) -> Project | None:
        ...
        Enforcement:
        - require_project=True: project_id required for all actions.
        - require_project_for_list=True: project_id required when action == "list".
        - Missing project_id when required raises ValidationError (400) via get_active_project().
        - Valid project_id pointing to a nonexistent project raises Http404.
        """
        ...
        if not project and required:
            ...
            # This handles the case: valid project_id provided but project doesn't exist.
